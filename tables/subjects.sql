...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 30 mrt 2016 om 21:10
-- Serverversie: 5.6.26
-- PHP-versie: 5.6.12
...
(2, 'Programmeermethoden', 'pr', 'informatica', '', 0, 'media\\books\\AbsoluteC++.pdf', 'http://liacs.leidenuniv.nl/~kosterswa/pm/', 'http://liacs.leidenuniv.nl/~kosterswa/pm/college.php', 'http://liacs.leidenuniv.nl/~kosterswa/pm/inhoud.php', 'http://liacs.leidenuniv.nl/~kosterswa/pm/opdrachten.php', 'http://liacs.leidenuniv.nl/~kosterswa/pm/cijf/res.html'),
(3, 'Fundamentele Informatica 1', 'fi1', 'informatica', '', 0, 'media\\books\\DS.pdf', 'http://liacs.leidenuniv.nl/~hoogeboomhj/fi1/', 'http://liacs.leidenuniv.nl/~hoogeboomhj/fi1/', 'http://liacs.leidenuniv.nl/~hoogeboomhj/fi1/', '', 'http://liacs.leidenuniv.nl/~hoogeboomhj/fi1/fi1-cijfers-dec-2015-site.pdf'),
...
(12, 'Logica', 'lo', 'informatica', '', 1, 'media\\books\\M. Huth and M. Ryan, “Logic in Computer Science – Modeling and Reasoning about systems”, Second Edition, Cambridge University Press, 2004-Ref8.pdf', 'http://liacs.leidenuniv.nl/~bonsanguemm/logic.xhtml', '', '', '', ''),
